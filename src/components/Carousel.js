...
const Carausel = () => {
    ...
    return (
        ...
        >
            ...
            {/* Slide 2 */}
            <div className="relative h-[580px] bg-banner2 bg-cover bg-center flex items-center">
                <div className="absolute inset-0 bg-black bg-opacity-30 blur-lg" data-aos="zoom-in-up"></div>
                <div className='relative flex flex-col justify-center items-start p-8 w-1/2 ml-8'>
                    ...
                    <p className='font-extrabold text-5xl text-white z-10 mb-4 text-start' data-aos="fade-right">
                        Harness the Power of Innovation
                    </p>
                    <p className='font-bold text-xl text-white z-10 text-start' data-aos="fade-left">
                        Discover how our tailored services can drive your success and future growth.
                    </p>
                    <div className='bg-red-800 text-white p-2 mt-4 rounded-lg'>
